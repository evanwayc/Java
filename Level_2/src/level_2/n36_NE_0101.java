...
class Coin {
    ...
    public void override(Head side) {
        System.out.println("Coin override(H)" + side.getSide());
    }

    public void override(Tail side) {
        System.out.println("Coin override(T)" + side.getSide());
    }

    public void override(Side side) {
        System.out.println("Coin override(S)" + side.getSide());
    }
